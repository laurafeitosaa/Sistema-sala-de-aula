...
const GerenciamentoAlunos = props => {
  ...
  function handleCreate(newData) {
    axios
      .post("http://demo2956687.mockable.io/alunos", {
        "id": newData.id,
        "cpf": newData.cpf,
  ...
  function handleUpdate(newData) {
    axios
      .put("http://demo2956687.mockable.io/alunos", {
        "id": newData.id,
        "cpf": newData.cpf,
        "matricula": newData.matricula,
        "nome": newData.nome,
  ...
  function handleDelete(newData) {
    axios
      .delete("http://demo2956687.mockable.io/delete-aluno", {
        "id": newData.id
      })
      .then(function (response) {
    ...
    [
      <MaterialTable
        ...
        columns={[
          ...
          { title: 'Endereço', field: 'idEndereco', lookup: enderecos.reduce((lookup, endereco) => {
            lookup[endereco.id] = endereco.rua;
            return lookup;
          }, {}) },
